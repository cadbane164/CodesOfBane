// mergedLL.cpp : Defines the entry point for the console application.
//
...
void merge(struct link *list1, struct link *list2)
{
	...
	if (node1 = node2)
	{
		cout << "both the list are merging into each other" << endl;
	}
	else
	{
...
int main()
{
	...
	cout << "enter the data(head1):" << endl;
	cin >> data;
	head1 ->a = data;
	head1->next = NULL;
	insert(&head1);
	...
	cout << "enter the data(head2):" << endl;
	cin >> data;
	head2->a = data;
	head2->next = NULL;
	insert(&head2);
